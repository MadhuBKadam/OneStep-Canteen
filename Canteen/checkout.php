...
<section class="display-order">
    ...
    ?>    
    <p> <?php echo $fetch_cart['name'] ?> <span>(<?php echo '<i class="fa fa-inr"></i>'.$fetch_cart['price'].'/-'.' x '.$fetch_cart['quantity']  ?>)</span> </p>
    <?php
        }
        }else{
    ...
    ?>
    <div class="grand-total">grand total : <span><i class="fa fa-inr"></i><?php echo $grand_total; ?>/-</span></div>
</section>
